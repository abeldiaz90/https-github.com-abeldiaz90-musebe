			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingTwo">
						<h4 class="panel-title">
							<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Imagenes del Producto
					...
					<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
						<div class="panel-body">
							<div class="col-md-3 col-md-offset-6">
								<dx:ASPxImageGallery ID="imageGallery" Width="100%" runat="server">
									<SettingsFolder ImageCacheFolder="~\Thumb\" />
								</dx:ASPxImageGallery>
								<dx:ASPxBinaryImage ID="imgBinaria" runat="server" Width="70%" Height="40%" ShowLoadingImage="true"></dx:ASPxBinaryImage>
								<p></p>
								<asp:LinkButton ID="lnkImagenes" runat="server" OnClick="lnkImagenes_Click">Galeria de Imagenes</asp:LinkButton>
								<asp:LinkButton ID="lnkCambiarImagenPrincipal" runat="server" OnClick="lnkCambiarImagenPrincipal_Click">Cambiar Imagen Principal</asp:LinkButton>
							</div>
						</div>
					</div>
				</div>
					...
					<dx:PopupControlContentControl runat="server">
						...
						<dx:ASPxGridView ID="grdResultadosBusqueda" runat="server" AutoGenerateColumns="False" DataSourceID="Resultados" EnableTheming="True" Theme="Aqua" Width="100%" KeyFieldName="Id">
							<Columns>
								...
								<dx:GridViewDataBinaryImageColumn FieldName="Imagen" ShowInCustomizationForm="True" VisibleIndex="4">
									<PropertiesBinaryImage ImageAlign="Middle" ImageHeight="30%" ImageWidth="30%" ImageSizeMode="FitProportional" ShowLoadingImage="True" IsPng="True">

...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
	<asp:UpdatePanel ID="UpdatePanel2" runat="server">
		<ContentTemplate>
			...
			<dx:ASPxPopupControl ID="popupGaleria" runat="server" Modal="true" Maximized="true" ScrollBars="Auto" ShowPageScrollbarWhenModal="True" PopupVerticalAlign="WindowCenter" PopupHorizontalAlign="WindowCenter" HeaderText="Galeria" Theme="Aqua">
				<ContentStyle HorizontalAlign="Center">
				</ContentStyle>
				<ContentCollection>
					<dx:PopupControlContentControl runat="server">
						<dx:ASPxImageSlider ID="imageGallery" runat="server" Height="100%" Width="100%">
							<SettingsAutoGeneratedImages ImageCacheFolder="~\Thumb\" ImageHeight="" ImageWidth="" />
						</dx:ASPxImageSlider>
					</dx:PopupControlContentControl>
				</ContentCollection>
			</dx:ASPxPopupControl>
			<dx:ASPxPopupControl ID="popupCargaImagenes" runat="server" Modal="true" Maximized="true" ScrollBars="Auto" ShowPageScrollbarWhenModal="True" AllowDragging="True" AllowResize="True" Theme="Aqua">
				<ContentStyle HorizontalAlign="Center">
				</ContentStyle>
				<ContentCollection>
					<dx:PopupControlContentControl runat="server">
						<dx:ASPxFileManager ID="ArchivosGaleriasFotos" runat="server" EnableTheming="True" Theme="Aqua">
						...
						<dx:ASPxButton ID="btnCargarGaleria" runat="server" OnClick="btnCargarGaleria_Click" Text="Vista Previa" Theme="Aqua">
						</dx:ASPxButton>
					</dx:PopupControlContentControl>
				</ContentCollection>
			</dx:ASPxPopupControl>
			...
			<dx:ASPxPopupControl ID="popupImagen" runat="server" ClientInstanceName="popupImagen" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" Theme="Aqua" Height="700PX" Width="100%" AllowDragging="True" AllowResize="True" AutoUpdatePosition="True" CloseOnEscape="True" Maximized="True" Modal="True" ShowFooter="True" ShowMaximizeButton="True" ShowPageScrollbarWhenModal="True">
				<ContentStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="True">
				</ContentStyle>
				<ContentCollection>
					<dx:PopupControlContentControl runat="server">
						<dx:ASPxCallbackPanel ID="CP" runat="server" ClientInstanceName="CP" OnCallback="CP_Callback" Width="100%" EnableCallbackAnimation="True" EnableTheming="True" Theme="Glass">
							<ClientSideEvents EndCallback="function(s, e) {

}" />
							<PanelCollection>
								<dx:PanelContent runat="server">
									<dx:ASPxBinaryImage ID="imgBinaria" runat="server" ClientInstanceName="imgBinaria" ImageAlign="Middle" ImageSizeMode="FitProportional" IsPng="True" Value='<%# Eval("Imagen") %>' Width="50%" Height="50%" ShowLoadingImage="True">
									</dx:ASPxBinaryImage>
								</dx:PanelContent>
							</PanelCollection>
						</dx:ASPxCallbackPanel>

						<dx:ASPxUploadControl ID="SubirImagen" runat="server" AutoStartUpload="True" FileUploadMode="OnPageLoad" ShowProgressPanel="True" Theme="Aqua" UploadMode="Auto" Width="100%" OnFileUploadComplete="SubirImagen_FileUploadComplete">
							<ClientSideEvents FileUploadComplete="function(s, e) {
window.alert('La foto ha sido cambiada');
CP.PerformCallback();
}" />

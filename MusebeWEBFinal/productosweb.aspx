	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<script type="text/javascript">
				...
				function mostrarGaleria(valor) {
					

					//var x = document.getElementsByName("galeriaProducto");
					
					//x.SettingsFolder.setAttribute('ImageSourceFolder', '~\\Imagenes\\Productos\\' + valor);
					//console.log(x)
					popupGaleria.Show();

				}

				function EstablecerValorGaleria(valor)
				{
					var valorGaleria="~\\Imagenes\\Productos" + valor+'\\';
				}
			</script>
			...
			<br />--%>
				...
				<asp:Label ID="ClaveLabel" runat="server" Text='<%# Eval("Clave") %>' ForeColor="Black" />
							...
							<a href="#" onclick='dataLayer.push({"event": "clickProducto","pageCategory": "Productos","AccionProductos": "<%# Eval("Producto") %>","EtiquetaProductos": "<%# Eval("Descripcion") %>"});'>
			...
			<dx:ASPxPopupControl ID="popupCarrito" runat="server" HeaderText="Mi carrito" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" MaxHeight="600px" Width="600px" ClientInstanceName="popupCarrito" Theme="Aqua" AllowDragging="True" AllowResize="True" AutoUpdatePosition="True" CloseOnEscape="True" Height="600px" ScrollBars="Auto" ShowMaximizeButton="True" ShowPageScrollbarWhenModal="True">
				<ContentCollection>
					<dx:PopupControlContentControl runat="server">
						<div class="row">
							<div class="col-md-6">
								<dx:ASPxBinaryImage ID="imgProducto" runat="server" ImageAlign="Middle" IsPng="True" ShowLoadingImage="True">
								</dx:ASPxBinaryImage>
								<br />
			...
			<dx:ASPxPopupControl ID="popupGaleria" runat="server" HeaderText="Galeria" Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" MaxHeight="600px" Width="600px" ClientInstanceName="popupGaleria" Theme="Aqua" AllowDragging="True" AllowResize="True" AutoUpdatePosition="True" CloseOnEscape="True" Height="600px" ScrollBars="Auto" ShowMaximizeButton="True" ShowPageScrollbarWhenModal="True">
				<ContentCollection>
					<dx:PopupControlContentControl runat="server">
						<dx:ASPxImageSlider ID="galeriaProducto" ClientInstanceName="galeriaProducto" ImageSourceFolder='~\\Imagenes\\Productos\\1' runat="server">

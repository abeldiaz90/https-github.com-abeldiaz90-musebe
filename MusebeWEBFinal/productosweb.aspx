...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
				...
				<asp:Label ID="ClaveLabel" runat="server" Text='<%# Eval("Clave") %>' ForeColor="Black" />
							...
							<a href="#">
								<dx:ASPxBinaryImage ID="ASPxBinaryImage1" runat="server" Value='<%# Eval("Imagen") %>' Width="100%" Height="100%" ImageAlign="TextTop">
									...
									<br />
							<button type="button" class="btn btn-default" aria-label="Left Align" title="Detalles" onclick='dataLayer.push({"event": "clickProducto","pageCategory": "Productos","AccionProductos": "<%# Eval("Producto") %>","EtiquetaProductos": "<%# Eval("Descripcion") %>"});'>
			...
			<a href="#"	name="color" onclick="dataLayer.push({'event': 'clickProducto','pageCategory': 'Productos','AccionProductos': 'Cafe','EtiquetaProductos': 'Cafe de Olla'});">Customize Color</a>
		</ContentTemplate>
		<Triggers>
